package cn.iocoder.yudao.module.flink.v119.api;
...
@Validated
public class Flink119ApiImpl implements Flink119Api {
  ...
  @Override
  public CommonResult<JobDeployRespDto> deployDataIngestion(JobDeployDataIngestionReqDto reqDto) {

    log.info("flink版本{}开始提交数据集成作业", getVersion());

    JobDeployRespDto respDto = flinkJobDeployService.deployDataIngestion(reqDto);
