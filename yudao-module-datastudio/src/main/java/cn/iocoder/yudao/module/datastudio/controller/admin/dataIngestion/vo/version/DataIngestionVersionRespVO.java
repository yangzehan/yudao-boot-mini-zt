 ...
 */
@Data
@Schema(name = "数据摄取版本响应 VO")
public class DataIngestionVersionRespVO {
    ...
    public static DataIngestionVersionRespVO of(DataIngestionVersionDO versionDO) {
        DataIngestionVersionRespVO respVO = new DataIngestionVersionRespVO();
