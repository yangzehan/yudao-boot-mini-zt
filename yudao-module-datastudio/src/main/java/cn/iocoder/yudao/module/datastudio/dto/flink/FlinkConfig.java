package cn.iocoder.yudao.module.datastudio.dto.flink;
...
public class FlinkConfig implements Serializable {
     ...
     * 添加扩展配置项
     */
    public void setExtendedConfigValue(String key, Object value) {
     ...
     * 获取扩展配置项（带默认值）
     */
    public Object getExtendedConfigValue(String key, Object defaultValue) {
        if (this.extendedConfig == null) {
            return defaultValue;
        }
