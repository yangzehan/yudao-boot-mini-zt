...
public class FlinkClusterBaseVO {
    ...
    @Schema(description = "集群状态：running-运行中，stopped-已停止，available-可用，unavailable-不可用", example = "stopped")
    ...
    @Schema(description = "Yarn ResourceManager地址（yarn类型）", example = "http://10.1.1.102:8088")
    ...
    @Schema(description = "Hadoop版本", example = "3.3.0")
    private String hadoopVersion;

    @Schema(description = "集群总内存（MB）", example = "16384")
