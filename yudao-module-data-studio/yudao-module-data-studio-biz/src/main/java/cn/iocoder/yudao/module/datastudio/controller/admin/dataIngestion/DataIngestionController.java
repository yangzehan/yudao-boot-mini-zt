...
public class DataIngestionController {
  ...
  @Resource private DataIngestionService dataIngestionService;
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:query')")
  public CommonResult<List<DataIngestionRespVO>> getFilesByParentId(
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:query')")
  public CommonResult<List<DataIngestionRespVO>> searchFiles(
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:update')")
  public CommonResult<Boolean> saveFileData(
      @Valid @RequestBody DataIngestionDataSaveReqVO saveReqVO) {
  ...
  public CommonResult<String> deploy(@PathVariable Long id) {
    return success(dataIngestionService.deploy(id));
  }
}
