 ...
 */
@Data
@Schema(name = "SQL编辑器版本详情响应 VO")
public class SqlEditVersionDetailRespVO {
    ...
    @Schema(name = "Flink配置", required = true)
    ...
    public static SqlEditVersionDetailRespVO of(SqlEditVersionDO versionDO) {
        SqlEditVersionDetailRespVO respVO = new SqlEditVersionDetailRespVO();
