package cn.iocoder.yudao.module.datastudio.controller.admin.sql;

import static cn.iocoder.yudao.framework.common.pojo.CommonResult.success;

import cn.iocoder.yudao.framework.common.pojo.CommonResult;
import cn.iocoder.yudao.framework.common.util.object.BeanUtils;
import cn.iocoder.yudao.module.datastudio.controller.admin.sql.vo.file.SqlEditListReqVO;
import cn.iocoder.yudao.module.datastudio.controller.admin.sql.vo.resp.SqlEditDataRespVO;
import cn.iocoder.yudao.module.datastudio.controller.admin.sql.vo.resp.SqlEditRespVO;
import cn.iocoder.yudao.module.datastudio.controller.admin.sql.vo.save.SqlEditDataSaveReqVO;
...
public class SqlEditController {
  ...
  @Resource private SqlEditService sqlEditService;
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:query')")
  public CommonResult<List<SqlEditRespVO>> getFilesByParentId(
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:update')")
  public CommonResult<Boolean> moveFile(
      @RequestParam("id") Long id, @RequestParam("targetParentId") Long targetParentId) {
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:update')")
  public CommonResult<Boolean> renameFile(
  ...
  @PreAuthorize("@ss.hasPermission('datastudio:file:update')")
  public CommonResult<Boolean> saveFileContent(
