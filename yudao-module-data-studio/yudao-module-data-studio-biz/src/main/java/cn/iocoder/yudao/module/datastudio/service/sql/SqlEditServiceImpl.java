package cn.iocoder.yudao.module.datastudio.service.sql;
...
public class SqlEditServiceImpl implements SqlEditService {
  ...
  @Resource private SqlEditConfigMapper sqlEditConfigMapper;

  @Resource private SqlEditVersionMapper sqlEditVersionMapper;
  ...
  public void saveFileData(SqlEditDataSaveReqVO saveReqVO) {
    ...
    Long currentVersionNumber =
        sqlEditVersionMapper.selectMaxVersionNumberBySqlEditId(saveReqVO.getId());
